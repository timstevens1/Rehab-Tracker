...
//
        ...
        <div>
            ...
            <!--            <form class="form-signin" method="post" id="register-form">
                            ...
                            <h2 class="form-signin-heading">Add New Patient</h2><hr />-->
            ...
            <form action="<?php print $phpSelf; ?>"
                ...
                <!--<fieldset class = "wrapper">-->
                    ...
                    <div class="form-group">
                        ...
                        <label for="fnkCLIN">Clinician 
                            <select id="fnkCLIN" name = "fnkCLIN"
                                    tabindex="100" placeholder="Enter Clinician ID" >';
                                        <?php
                                        if ($docIDERROR)
                                            print 'class="mistake"';
                    ...
                    <div class="form-group">
                        <!--    <button type="submit" class="btn btn-default" name="btnSubmit">
                                <span class="glyphicon glyphicon-log-in"></span> &nbsp; Add Patient
                            </button> -->
