...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style.css">
        ...
        require_once(realpath($includeLibPath .'custom-functions.php'));
        require_once(realpath($includeLibPath . 'mail-message.php'));
        require_once(realpath($includeLibPath .'security.php'));
        require_once(realpath($includeLibPath .'validation-functions.php'));
        
        require_once(realpath($includeDBPath . 'Database.php'));
