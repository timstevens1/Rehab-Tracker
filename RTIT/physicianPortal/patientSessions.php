...
$querypatient = 'SELECT pmkPatientID, fnkCLIN, fldDeviceSynced, fldStartDate, fldComplianceChecked, fldWeekCompliance, fldGoal, fldWeekStart FROM ' . $tblPatient .
...
////now print out each record
$query = "SELECT tblPatient.pmkPatientID, fldSessNum, fldSessionCompliance, fldIntensity1, fldIntensity2, fldGoal, fldNote, fldStartTime, fldEndTime "
...
$columns = 9; //hard coded this value b/c hard coded headers where columns was calculated
